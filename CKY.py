# -*- coding: utf-8 -*-
"""
Created on Fri Jul 10 15:34:31 2015
...
class CKY :
    def __init__(self):
        ...
        self.input_file_path="output/CNFrules.txt"
        self.output_file_path="output/final_output.txt"
        self.N=[]           # set of non terminals
        self.N_file="output/non_terminals.txt"
        self.rule_file="output/CNFrules.txt"
